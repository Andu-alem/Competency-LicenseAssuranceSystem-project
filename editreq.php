...
<h1>Update Record of requests</h1>
<?php
...
$code =$_REQUEST['code'];
 ...
 // UPDATE `request_info` SET `full_name`=[value-1],`telephone`=[value-2],`telephone_for_service`=[value-3],`fax_for_service`=[value-4],`amount_of_internet`=[value-5],`photo`=[value-6],`code`=[value-7],`year`=[value-8],`months`=[value-9],`date`=[value-10],`submition_date`=[value-11],`comment`=[value-12],`files`=[value-13],`phone_aggrement`=[value-14],`fax_aggrement`=[value-15],`internet_aggrement`=[value-16] WHERE 1 
...
<p>HOUSE NO:<input type="text"house_no name="house_no" placeholder="Enter H NO" required value="<?php echo $row1['house_no'];
?>" /></p>
